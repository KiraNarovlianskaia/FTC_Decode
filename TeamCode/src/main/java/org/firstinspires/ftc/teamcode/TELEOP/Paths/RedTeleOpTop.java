...
@Configurable
@TeleOp(name="Red TeleOp Top")

public class RedTeleOpTop extends LinearOpMode {
    ...
    private Supplier<PathChain> pathChainShootBottom;
    ...
    public void runOpMode() {
        ...
        pathChainShootBottom = () -> follower.pathBuilder()
