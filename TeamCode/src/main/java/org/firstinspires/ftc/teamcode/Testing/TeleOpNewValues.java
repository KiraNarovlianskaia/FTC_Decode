...
public class TeleOpNewValues extends LinearOpMode {
    ...
    public void runOpMode(){
        ...
        while (opModeIsActive()) {
            ...
            ball_left_present = colors.alpha > 0.3;
            ball_right_present = colors2.alpha > 0.3;

            telemetry.addData("Left ball: ", ball_left_present);
            telemetry.addData("Right ball: ", ball_right_present);
